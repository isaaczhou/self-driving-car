...
=======
     - Cross Entropy Table [[./resources/cross-entropy.png]]

     - Cross-Entropy Formula [[./resources/cross-entropy-formula.png]]
>>>>>>> 032f93c24cdb9dcf9559cfdf061b6875dea3db47
**** Code
#+BEGIN_SRC ipython :session :file  :exports both :results raw drawer
import numpy as np
...
=======
    - Multi-class cross entropy, the sum of columns should be 1 [[./resources/multi-class-cross-entropy-col-sum.png]]
    - Calculate the multi-class cross entropy [[./resources/multi-class-cross-entropy-demo.png]]

    - The formula for multi-class cross entropy [[./resources/multi-class-cross-entropy-formula.png]]
